...
case "$MODE" in
    ...
    region)
        freeze_screen
        set +e
        SELECTION=$(slurp -b 00000033 -c 7aa2f7aa -s 00000000 -w 1)
        STATUS=$?
        set -e
    ...
    window)
        ...
        set +e
        SELECTION=$(slurp -b 00000033 -c 7aa2f7aa -s 00000000 -w 1 -r <<< "$CLIENTS")
        STATUS=$?
        set -e
    ...
    smart)
        ...
        set +e
        SELECTION=$(slurp -b 00000033 -c 7aa2f7aa -s 00000000 -w 1 <<< "$RECTS")
        STATUS=$?
        set -e

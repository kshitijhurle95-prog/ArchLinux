...
CATALOGUE: Final[tuple[Category, ...]] = (
    Category(
        ...
        accent=C.ACCENT,
        binds=(
            Bind(("SUPER", "RETURN"),        "Launch Terminal",         Tag.ACCENT),
            Bind(("SUPER", "B"),             "Launch Chrome Browser",   Tag.ACCENT),
            Bind(("SUPER", "E"),             "Launch File Manager",     Tag.ACCENT),
            Bind(("SUPER", "R"),             "Open Text Editor",        Tag.ACCENT),
            Bind(("SUPER", "SPACE"),         "App Launcher (Rofi)",     Tag.SUCCESS),
            Bind(("SUPER", "I"),             "Ryoku Settings",          Tag.SUCCESS),
            Bind(("SUPER", "ESC"),           "Dusky QuickPanal",        Tag.SUCCESS),
            Bind(("SUPER", "Q"),             "Wallpaper & Theme Menu",  Tag.SUCCESS),
            Bind(("SUPER", ","),             "Emoji Picker & Insert",   Tag.SUCCESS),
        ),
    ),
    Category(
        ...
        accent=C.SUCCESS,
        binds=(
            Bind(("SUPER", "W"),                "Close Focused Window",   Tag.DANGER),
            Bind(("SUPER", "F"),                "Fully Maximize / Restore", Tag.WARNING),
            Bind(("F11",),                      "Fully Maximize / Esc Exit", Tag.WARNING),
            Bind(("SHIFT", "F11"),              "Pure Fullscreen Mode",    Tag.WARNING),
            Bind(("SUPER", "A"),                "Smart Float & Center",   Tag.ACCENT),
            Bind(("SUPER", "CTRL", "H/J/K/L"),  "Resize Active Window",   Tag.MUTED),
            Bind(("SUPER", "SHIFT", "H/J/K/L"), "Swap Window Position",   Tag.ACCENT),
            Bind(("SUPER", "H/J/K/L"),          "Focus Directionally",    Tag.MUTED),
            Bind(("SUPER", "DRAG"),             "Move / Resize Window",   Tag.MUTED),
            Bind(("SUPER", "V"),                "Clipboard Manager",      Tag.SUCCESS),
        ),
    ),
    Category(
    ...
    Category(
        ...
        accent=C.ERROR,
        binds=(
            Bind(("SUPER", "L"),             "Lock Screen (Hyprlock)",  Tag.DANGER),
            Bind(("SUPER", "C"),             "Color Picker",            Tag.ACCENT),
            Bind(("ALT", "SPACE"),           "STT Parakeet Voice Type", Tag.SUCCESS),
            Bind(("SUPER", "*"),             "Toggle Window Blur",      Tag.ACCENT),

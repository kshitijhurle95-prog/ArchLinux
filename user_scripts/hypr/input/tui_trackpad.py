...
SCHEMA = {
    ...
    2: [
        ...
        ConfigItem(
            ...
            hints=GESTURE_HINTS,
            group="Quad",
            extended_help="**4-Finger Horizontal Swipe (Continuous)**\n\nAssigns an action to continuous horizontal swiping with four fingers for native 1:1 workspace switching."
        ),
        ConfigItem(

...
set -g fish_color_comment {{colors.on_surface_variant.default.hex_stripped}}
...
--color=marker:{{colors.tertiary.default.hex}},spinner:{{colors.secondary.default.hex}},header:{{colors.on_surface_variant.default.hex}} \

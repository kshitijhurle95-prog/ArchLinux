...
Item {
    ...
    property real barOpacity:  0.30   // durchgehende V2-Leiste (translucent 30%)
    property real pillOpacity: 0.30   // einzelne Widget-Pillen

    // Translucent 30% black background for panels
    readonly property real surfaceOpacity: 0.30
    readonly property color bg:     Qt.rgba(0, 0, 0, 0.30)
    readonly property color barBg:  Qt.rgba(0, 0, 0, 0.30)
    readonly property color pill:   Qt.rgba(0, 0, 0, 0.30)
    ...
    readonly property int v2BarHeight: 26
    ...
    readonly property color v2BarShadow: "transparent"
    ...
    readonly property int   pillBorderW:  0
    readonly property int   tileRadius:   10
    readonly property int   wsPillPad:    0
    readonly property color pillShadow:   Qt.rgba(0, 0, 0, 0.40)
    ...
    readonly property bool idleInhibited: Flags.keepAwake
    // ── Notification state ──

                    ...
                    Column {
                        ...
                        Repeater {
                            ...
                            delegate: Item {
                                ...
                                readonly property string iconSource: modelData.iconPath
                                    ? (modelData.iconPath.indexOf("/") === 0 ? ("file://" + modelData.iconPath) : modelData.iconPath)
                                    : (modelData.iconName ? Quickshell.iconPath(modelData.iconName, true) : Quickshell.iconPath("application-x-executable", true))
                                ...
                                Rectangle {
                                    ...
                                    height: 28
                                    radius: root.panelButtonRadius
                                    color: menuMa.containsMouse ? root.fillHover : root.fillIdle
                                    border.color: menuMa.containsMouse ? root.seal : root.sep
                                    border.width: 1
                                    opacity: 1.0
                                    Behavior on color { ColorAnimation { duration: 120 } }
                                    ...
                                    UiText {
                                        anchors.centerIn: parent
                                        text: I18n.tr("Menu")
                                        color: menuMa.containsMouse ? root.seal : root.ink
                                        font.family: root.mono
                                        font.pixelSize: 11
                                    }

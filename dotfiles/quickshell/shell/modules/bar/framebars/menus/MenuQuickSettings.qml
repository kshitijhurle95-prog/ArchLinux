...
Item {
    ...
    Item {
        ...
        // Translucent dark glass surface backing (~70% opacity)
        Rectangle {
            anchors.fill: parent
            color: Qt.rgba(14/255, 12/255, 24/255, 0.72)
        }
        ...
        Column {
            ...
            Item {
                ...
                Rectangle {
                    ...
                    height: 32
                    radius: 8
                    color: backMa.containsMouse ? Qt.rgba(130/255, 90/255, 230/255, 0.35) : Qt.rgba(36/255, 28/255, 56/255, 0.65)
                    border.width: 1
                    border.color: backMa.containsMouse ? Qt.rgba(165/255, 125/255, 250/255, 0.65) : Qt.rgba(140/255, 100/255, 230/255, 0.35)

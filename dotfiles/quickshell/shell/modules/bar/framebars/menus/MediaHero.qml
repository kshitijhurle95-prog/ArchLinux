...
Item {
    ...
    Rectangle {
        id: heroCard
        width: root.width; radius: Theme.radiusWidget; color: Qt.rgba(24/255, 18/255, 40/255, 0.60)
        border.width: 1; border.color: Qt.rgba(95/255, 75/255, 150/255, 0.25)
        clip: true
        ...
        Rectangle {
            anchors.fill: parent
            color: Qt.rgba(20/255, 16/255, 34/255, 0.60)
        }

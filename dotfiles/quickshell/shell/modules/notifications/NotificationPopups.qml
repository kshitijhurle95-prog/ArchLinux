...
PanelWindow {
    ...
    ListView {
        ...
        delegate: NotificationCard {
            ...
            // about the anchored corner (bottom-right, bottom-left or bottom-centre).
            compact: true
            transformOrigin: win.position === "Left" ? Item.BottomLeft
                : win.position === "Center" ? Item.Bottom : Item.BottomRight
